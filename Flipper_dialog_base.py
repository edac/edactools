...
class Ui_FlipperDialog(object):
    def setupUi(self, FlipperDialog):
        ...
        self.FlipperRastercomboBox.setGeometry(QtCore.QRect(0, 10, 421, 25))
        ...
        self.max_spinbox.setGeometry(QtCore.QRect(280, 60, 101, 26))
        ...
        self.band_label.setGeometry(QtCore.QRect(160, 40, 67, 16))
